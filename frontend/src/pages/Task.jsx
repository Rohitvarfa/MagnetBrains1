  ...
  useEffect(() => {
    if (mode === "update") {
      ...
      fetchData(config, { showSuccessToast: false }).then((data) => {
        setTask(data.task);
        setFormData({ description: data.task.description, status: data.task.status, priority: data.task.priority });
      });
    }
          ...
          {loading ? (
            ...
            <>
              ...
              <div className='mb-4'>
                ...
                <select name="status" id="status" className='w-full rounded-md border-2 border-gray-300 px-4 py-2 focus:outline-none focus:border-indigo-600' value={formData.status} onChange={handleChange}>
              ...
              <div className='mb-4'>
                ...
                <select name="priority" id="priority" className='w-full rounded-md border-2 border-gray-300 px-4 py-2 focus:outline-none focus:border-indigo-600' value={formData.priority} onChange={handleChange}>

...
exports.postTask = async (req, res) => {
  try {
    ...
    const task = await Task.create({ user: req.user.id, description, status, priority });
...
exports.putTask = async (req, res) => {
  try {
    ...
    task = await Task.findByIdAndUpdate(req.params.taskId, { description, status, priority}, { new: true });
